...
namespace Inventario.Controllers
{
    public class BodegasController : Controller
    {
        ...
        public BodegasController(DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,nameBodega,FechaActualización")] Bodega bodega)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,nameBodega,FechaActualización")] Bodega bodega)
        {
            if (id != bodega.Id)
            {
                return NotFound();
