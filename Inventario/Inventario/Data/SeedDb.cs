...
namespace Inventario.Data
{
    public class SeedDb
    {
        ...
        private async Task<Users> CheckUserAsync(string document, string firstName, string lastName, string email, string phone, string address, string role)
        {
        ...
        //private async Task CheckLesseesAsync(Users user)
        //{
        ...
        //private async Task CheckOwnersAsync(Users user)
        //{
